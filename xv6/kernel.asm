...
8010324f:	e8 ac 14 00 00       	call   80104700 <memcmp>
...
801033a8:	e8 53 13 00 00       	call   80104700 <memcmp>
...
80103489:	e8 42 0f 00 00       	call   801043d0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010350f:	e8 ac 10 00 00       	call   801045c0 <acquire>
  if(writable){
...
8010352f:	e8 cc 0b 00 00       	call   80104100 <wakeup>
...
80103553:	5d                   	pop    %ebp
    release(&p->lock);
80103554:	e9 07 10 00 00       	jmp    80104560 <release>
80103559:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103560:	83 ec 0c             	sub    $0xc,%esp
80103563:	53                   	push   %ebx
80103564:	e8 f7 0f 00 00       	call   80104560 <release>
    kfree((char*)p);
...
801035b0:	e8 0b 10 00 00       	call   801045c0 <acquire>
  for(i = 0; i < n; i++){
...
80103610:	e8 eb 0a 00 00       	call   80104100 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103615:	58                   	pop    %eax
80103616:	5a                   	pop    %edx
80103617:	53                   	push   %ebx
80103618:	57                   	push   %edi
80103619:	e8 22 0a 00 00       	call   80104040 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103644:	e8 17 0f 00 00       	call   80104560 <release>
        return -1;
...
80103698:	e8 63 0a 00 00       	call   80104100 <wakeup>
  release(&p->lock);
8010369d:	89 1c 24             	mov    %ebx,(%esp)
801036a0:	e8 bb 0e 00 00       	call   80104560 <release>
  return n;
...
801036d6:	e8 e5 0e 00 00       	call   801045c0 <acquire>
...
80103705:	e8 36 09 00 00       	call   80104040 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010376e:	e8 ed 0d 00 00       	call   80104560 <release>
  return i;
...
80103789:	e8 d2 0d 00 00       	call   80104560 <release>
      return -1;
...
801037de:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->priority = 1;
801037e5:	c7 43 7c 01 00 00 00 	movl   $0x1,0x7c(%ebx)
  p->pid = nextpid++;
...
801037f7:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037fd:	e8 5e 0d 00 00       	call   80104560 <release>
...
8010381f:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103822:	c7 40 14 12 59 10 80 	movl   $0x80105912,0x14(%eax)
  p->context = (struct context*)sp;
...
80103831:	e8 8a 0e 00 00       	call   801046c0 <memset>
...
801039e6:	e8 d5 0c 00 00       	call   801046c0 <memset>
...
80103b38:	0f 84 de 00 00 00    	je     80103c1c <fork+0x10c>
...
80103b55:	0f 84 a2 00 00 00    	je     80103bfd <fork+0xed>
  np->sz = curproc->sz;
...
80103b65:	89 02                	mov    %eax,(%edx)
  *np->tf = *curproc->tf;
80103b67:	8b 7a 18             	mov    0x18(%edx),%edi
  np->parent = curproc;
80103b6a:	89 5a 14             	mov    %ebx,0x14(%edx)
  *np->tf = *curproc->tf;
80103b6d:	8b 73 18             	mov    0x18(%ebx),%esi
80103b70:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103b72:	31 f6                	xor    %esi,%esi
  np->priority = curproc->priority;
80103b74:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103b77:	89 42 7c             	mov    %eax,0x7c(%edx)
  np->tf->eax = 0;
80103b7a:	8b 42 18             	mov    0x18(%edx),%eax
...
80103b94:	e8 27 d3 ff ff       	call   80100ec0 <filedup>
...
80103bb1:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
80103bb4:	e8 b7 db ff ff       	call   80101770 <idup>
...
80103bc9:	e8 a2 0c 00 00       	call   80104870 <safestrcpy>
  pid = np->pid;
80103bce:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bd1:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103bd8:	e8 e3 09 00 00       	call   801045c0 <acquire>
  np->state = RUNNABLE;
80103bdd:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103be4:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103beb:	e8 70 09 00 00       	call   80104560 <release>
  return pid;
...
80103bfc:	c3                   	ret
    kfree(np->kstack);
80103bfd:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103c00:	83 ec 0c             	sub    $0xc,%esp
80103c03:	ff 73 08             	push   0x8(%ebx)
80103c06:	e8 95 e8 ff ff       	call   801024a0 <kfree>
    np->kstack = 0;
80103c0b:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    return -1;
...
80103c21:	eb d0                	jmp    80103bf3 <fork+0xe3>
...
80103e9d:	68 fe 74 10 80       	push   $0x801074fe
80103ea2:	e8 d9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ea7:	83 ec 0c             	sub    $0xc,%esp
80103eaa:	68 f1 74 10 80       	push   $0x801074f1
...
80103fe0:	68 0a 75 10 80       	push   $0x8010750a
...
801040e9:	68 10 75 10 80       	push   $0x80107510
801040ee:	e8 8d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040f3:	83 ec 0c             	sub    $0xc,%esp
801040f6:	68 0a 75 10 80       	push   $0x8010750a
...
801041fb:	68 cf 76 10 80       	push   $0x801076cf
...
8010421c:	74 ea                	je     80104208 <procdump+0x28>
      state = "???";
8010421e:	ba 21 75 10 80       	mov    $0x80107521,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104223:	83 f8 05             	cmp    $0x5,%eax
80104226:	77 11                	ja     80104239 <procdump+0x59>
80104228:	8b 14 85 00 7b 10 80 	mov    -0x7fef8500(,%eax,4),%edx
      state = "???";
8010422f:	b8 21 75 10 80       	mov    $0x80107521,%eax
...
8010423e:	68 25 75 10 80       	push   $0x80107525
...
801042aa:	68 58 75 10 80       	push   $0x80107558
...
80104505:	68 63 75 10 80       	push   $0x80107563
8010450a:	e8 71 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010450f:	83 ec 0c             	sub    $0xc,%esp
80104512:	68 7a 75 10 80       	push   $0x8010757a
...
8010457b:	68 81 75 10 80       	push   $0x80107581
...
80104693:	e8 58 f2 ff ff       	call   801038f0 <mycpu>
...
801046a8:	68 89 75 10 80       	push   $0x80107589
...
80104acc:	8b 14 85 20 7b 10 80 	mov    -0x7fef84e0(,%eax,4),%edx
...
80104af8:	68 91 75 10 80       	push   $0x80107591
...
80104c44:	68 c9 75 10 80       	push   $0x801075c9
...
80104c5c:	68 c8 75 10 80       	push   $0x801075c8
...
8010507d:	58                   	pop    %eax
8010507e:	5a                   	pop    %edx
8010507f:	68 c9 75 10 80       	push   $0x801075c9
...
80105098:	68 c8 75 10 80       	push   $0x801075c8
...
801056c6:	78 78                	js     80105740 <sys_setpriority+0x90>
801056c8:	83 ec 08             	sub    $0x8,%esp
801056cb:	8d 45 f4             	lea    -0xc(%ebp),%eax
801056ce:	50                   	push   %eax
801056cf:	6a 01                	push   $0x1
801056d1:	e8 9a f2 ff ff       	call   80104970 <argint>
801056d6:	83 c4 10             	add    $0x10,%esp
801056d9:	85 c0                	test   %eax,%eax
801056db:	78 63                	js     80105740 <sys_setpriority+0x90>
    return -1;
  
  if(prio < 0 || prio > 2)
801056dd:	83 7d f4 02          	cmpl   $0x2,-0xc(%ebp)
801056e1:	77 5d                	ja     80105740 <sys_setpriority+0x90>
    return -1;

  acquire(&ptable.lock);
801056e3:	83 ec 0c             	sub    $0xc,%esp
801056e6:	68 20 1d 11 80       	push   $0x80111d20
801056eb:	e8 d0 ee ff ff       	call   801045c0 <acquire>
...
801056f3:	83 c4 10             	add    $0x10,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801056f6:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
801056fb:	eb 0d                	jmp    8010570a <sys_setpriority+0x5a>
801056fd:	8d 76 00             	lea    0x0(%esi),%esi
80105700:	83 e8 80             	sub    $0xffffff80,%eax
80105703:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80105708:	74 26                	je     80105730 <sys_setpriority+0x80>
    if (p->pid == pid && p->state != UNUSED) {
8010570a:	39 50 10             	cmp    %edx,0x10(%eax)
8010570d:	75 f1                	jne    80105700 <sys_setpriority+0x50>
8010570f:	8b 48 0c             	mov    0xc(%eax),%ecx
80105712:	85 c9                	test   %ecx,%ecx
80105714:	74 ea                	je     80105700 <sys_setpriority+0x50>
      p->priority = prio;
80105716:	8b 55 f4             	mov    -0xc(%ebp),%edx
      found = 1;
      break;
    }
  }
...
80105719:	83 ec 0c             	sub    $0xc,%esp
      p->priority = prio;
8010571c:	89 50 7c             	mov    %edx,0x7c(%eax)
  release(&ptable.lock);
8010571f:	68 20 1d 11 80       	push   $0x80111d20
80105724:	e8 37 ee ff ff       	call   80104560 <release>
...
80105733:	68 20 1d 11 80       	push   $0x80111d20
80105738:	e8 23 ee ff ff       	call   80104560 <release>
  if (found == 1)
...
80105755:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010575c:	00 
...
8010578c:	e8 df f1 ff ff       	call   80104970 <argint>
...
801057dd:	e8 8e f1 ff ff       	call   80104970 <argint>
...
8010582d:	e8 3e f1 ff ff       	call   80104970 <argint>
80105832:	83 c4 10             	add    $0x10,%esp
80105835:	85 c0                	test   %eax,%eax
80105837:	78 64                	js     8010589d <sys_sleep+0x7d>
    return -1;
  acquire(&tickslock);
80105839:	83 ec 0c             	sub    $0xc,%esp
8010583c:	68 80 3d 11 80       	push   $0x80113d80
80105841:	e8 7a ed ff ff       	call   801045c0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105846:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105849:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  while(ticks - ticks0 < n){
8010584f:	83 c4 10             	add    $0x10,%esp
80105852:	85 d2                	test   %edx,%edx
80105854:	75 2b                	jne    80105881 <sys_sleep+0x61>
80105856:	eb 58                	jmp    801058b0 <sys_sleep+0x90>
...
80105863:	68 80 3d 11 80       	push   $0x80113d80
80105868:	68 60 3d 11 80       	push   $0x80113d60
8010586d:	e8 ce e7 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
80105872:	a1 60 3d 11 80       	mov    0x80113d60,%eax
...
80105890:	68 80 3d 11 80       	push   $0x80113d80
80105895:	e8 c6 ec ff ff       	call   80104560 <release>
      return -1;
...
801058b3:	68 80 3d 11 80       	push   $0x80113d80
801058b8:	e8 a3 ec ff ff       	call   80104560 <release>
}
...
801058d4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058d7:	68 80 3d 11 80       	push   $0x80113d80
801058dc:	e8 df ec ff ff       	call   801045c0 <acquire>
  xticks = ticks;
801058e1:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  release(&tickslock);
801058e7:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
801058ee:	e8 6d ec ff ff       	call   80104560 <release>
  return xticks;
}
...
80105b55:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b58:	e8 53 ef ff ff       	call   80104ab0 <syscall>
    if(myproc()->killed)
...
80105bd5:	e8 e6 e9 ff ff       	call   801045c0 <acquire>
      ticks++;
...
80105bf4:	e8 67 e9 ff ff       	call   80104560 <release>
...
801069b7:	e8 04 dd ff ff       	call   801046c0 <memset>
...
80106b89:	5d                   	pop    %ebp
  popcli();
80106b8a:	e9 31 d9 ff ff       	jmp    801044c0 <popcli>
...
80106bef:	e8 cc da ff ff       	call   801046c0 <memset>
...
80106c20:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c21:	e9 2a db ff ff       	jmp    80104750 <memmove>
...
80106f00:	e8 bb d7 ff ff       	call   801046c0 <memset>
...
80107070:	e8 db d6 ff ff       	call   80104750 <memmove>
...
801071a0:	e8 ab d5 ff ff       	call   80104750 <memmove>
    len -= n;
    buf += n;
